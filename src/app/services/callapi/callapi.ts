...
export class Callapi {
  ...
  public CreateExaminationFinding(Create: ExaminationFindingDTO): Observable<ExaminationFindingDTO1> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.post<ExaminationFindingDTO1>(this.url + "ExaminationFinding/Add", Create, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public GetAllExaminationFinding(): Observable<ExaminationFindingListResponse> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.get<ExaminationFindingListResponse>(this.url + "ExaminationFinding/GetAll", { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public DeleteExaminationFinding(Id: string): Observable<any> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.delete<any>(this.url + `ExaminationFinding/Delete/${Id}`, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public GetExaminationFindingBySearchTearm(SearchTerm: string): Observable<ExaminationFindingListResponse> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.get<ExaminationFindingListResponse>(this.url + `ExaminationFinding/GetSearchTearm?SearchTerm=${SearchTerm}`, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public AddSaveExaminationFinding(Create: SaveExaminationFindingDTO): Observable<AddSaveExaminationFindingResponse> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.post<AddSaveExaminationFindingResponse>(this.url + "SaveExaminationFinding/Add", Create, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public GetInAppointmentSaveExaminationFinding(Id: string): Observable<ListSaveExaminationFindingResponse> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.get<ListSaveExaminationFindingResponse>(this.url + `SaveExaminationFinding/GetByAppointmentId/${Id}`, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
  ...
  public DeleteSaveExaminationFinding(Id: string): Observable<any> {
    const headers = new HttpHeaders({ 'Authorization': `Bearer ${this.token.getToken()}`, 'ngrok-skip-browser-warning': 'true' });
    return this.Http.delete<any>(this.url + `SaveExaminationFinding/Delete/${Id}`, { headers }).pipe(
      tap(response => { }),
      catchError(error => {
        return throwError(() => error);
      })
